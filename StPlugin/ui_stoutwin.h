/********************************************************************************
** Form generated from reading UI file 'stoutwin.ui'
**
...
#ifndef UI_STOUTWIN_H
#define UI_STOUTWIN_H
...
public:
    ...
    QLabel *label_8;
    QLabel *arrivalLabel;
    QLineEdit *dispatchNoEdit;
    QLabel *rdLabel;
    QTableWidget *tableWidget;
    QStatusBar *statusbar;
    QToolBar *toolBar;

    void setupUi(QMainWindow *StOutWin)
    {
        if (StOutWin->objectName().isEmpty())
            StOutWin->setObjectName(QString::fromUtf8("StOutWin"));
        StOutWin->resize(1087, 600);
        centralwidget = new QWidget(StOutWin);
        ...
        dispatchNoEdit = new QLineEdit(frame_2);
        dispatchNoEdit->setObjectName(QString::fromUtf8("dispatchNoEdit"));
        dispatchNoEdit->setReadOnly(true);

        headGridLayout->addWidget(dispatchNoEdit, 1, 4, 1, 1);
        ...
        StOutWin->setCentralWidget(centralwidget);
        statusbar = new QStatusBar(StOutWin);
        statusbar->setObjectName(QString::fromUtf8("statusbar"));
        StOutWin->setStatusBar(statusbar);
        toolBar = new QToolBar(StOutWin);
        toolBar->setObjectName(QString::fromUtf8("toolBar"));
        StOutWin->addToolBar(Qt::TopToolBarArea, toolBar);

        retranslateUi(StOutWin);

        QMetaObject::connectSlotsByName(StOutWin);
    } // setupUi

    void retranslateUi(QMainWindow *StOutWin)
    {
        StOutWin->setWindowTitle(QApplication::translate("StOutWin", "MainWindow", 0, QApplication::UnicodeUTF8));
        label_16->setText(QApplication::translate("StOutWin", "\345\205\266\344\273\226\345\207\272\345\272\223\345\215\225", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("StOutWin", "\344\270\232\345\212\241\351\203\250\351\227\250:", 0, QApplication::UnicodeUTF8));
        idLabel->setText(QApplication::translate("StOutWin", "\345\207\272\345\272\223\345\215\225\345\217\267:", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("StOutWin", "\345\256\242    \346\210\267:", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("StOutWin", "\345\207\272\345\272\223\346\227\245\346\234\237:", 0, QApplication::UnicodeUTF8));
        label_12->setText(QApplication::translate("StOutWin", "\344\270\232 \345\212\241 \345\221\230:", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("StOutWin", "\345\215\225\346\215\256\347\261\273\345\236\213:", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("StOutWin", "\344\273\223    \345\272\223:", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("StOutWin", "\345\244\207    \346\263\250:", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("StOutWin", "\345\256\241 \346\240\270 \344\272\272:", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("StOutWin", "\345\210\266 \345\215\225 \344\272\272:", 0, QApplication::UnicodeUTF8));
        arrivalLabel->setText(QApplication::translate("StOutWin", "\346\272\220 \345\215\225 \345\217\267:", 0, QApplication::UnicodeUTF8));
        rdLabel->setText(QString());
        toolBar->setWindowTitle(QApplication::translate("StOutWin", "toolBar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class StOutWin: public Ui_StOutWin {};
} // namespace Ui
