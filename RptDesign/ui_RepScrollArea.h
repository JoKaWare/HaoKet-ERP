...
public:
    ...
    void setupUi(QScrollArea *RepScrollArea)
    {
        if (RepScrollArea->objectName().isEmpty())
            RepScrollArea->setObjectName(QString::fromUtf8("RepScrollArea"));
        RepScrollArea->resize(678, 611);
        RepScrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QString::fromUtf8("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 894, 1236));
        ...
        horRuler->setObjectName(QString::fromUtf8("horRuler"));
        ...
        topMarginsSpacer = new QSpacerItem(20, 0, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_52->addItem(topMarginsSpacer);

        verRuler = new QWidget(scrollAreaWidgetContents);
        verRuler->setObjectName(QString::fromUtf8("verRuler"));
        ...
        verRuler->setMinimumSize(QSize(20, 0));
        QPalette palette1;
        ...
        repWidget->setObjectName(QString::fromUtf8("repWidget"));
        ...
        verticalLayout_5->addWidget(repWidget);
    ...
    {
        RepScrollArea->setWindowTitle(QApplication::translate("RepScrollArea", "ScrollArea", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
