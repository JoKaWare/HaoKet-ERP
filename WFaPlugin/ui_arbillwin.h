/********************************************************************************
** Form generated from reading UI file 'arbillwin.ui'
**
...
#ifndef UI_ARBILLWIN_H
#define UI_ARBILLWIN_H
...
public:
    ...
    void setupUi(QMainWindow *ArBillWin)
    {
        if (ArBillWin->objectName().isEmpty())
            ArBillWin->setObjectName(QString::fromUtf8("ArBillWin"));
        ArBillWin->resize(945, 600);
        centralwidget = new QWidget(ArBillWin);
        ...
        headGridLayout->addItem(horizontalSpacer, 3, 11, 1, 1);
        ...
        arLabel = new QLabel(frame_2);
        arLabel->setObjectName(QString::fromUtf8("arLabel"));

        headGridLayout->addWidget(arLabel, 2, 0, 1, 1);
        ...
        ArBillWin->setCentralWidget(centralwidget);
        statusbar = new QStatusBar(ArBillWin);
        statusbar->setObjectName(QString::fromUtf8("statusbar"));
        ArBillWin->setStatusBar(statusbar);
        toolBar = new QToolBar(ArBillWin);
        toolBar->setObjectName(QString::fromUtf8("toolBar"));
        ArBillWin->addToolBar(Qt::TopToolBarArea, toolBar);

        retranslateUi(ArBillWin);

        QMetaObject::connectSlotsByName(ArBillWin);
    } // setupUi

    void retranslateUi(QMainWindow *ArBillWin)
    {
        ArBillWin->setWindowTitle(QApplication::translate("ArBillWin", "MainWindow", 0, QApplication::UnicodeUTF8));
        titleLabel->setText(QApplication::translate("ArBillWin", "\346\224\266\346\254\276\345\215\225", 0, QApplication::UnicodeUTF8));
        idLabel->setText(QApplication::translate("ArBillWin", "\346\224\266\346\254\276\345\215\225\345\217\267:", 0, QApplication::UnicodeUTF8));
        busLabel->setText(QApplication::translate("ArBillWin", "\345\256\242    \346\210\267:", 0, QApplication::UnicodeUTF8));
        dateLabel->setText(QApplication::translate("ArBillWin", "\346\224\266\346\254\276\346\227\245\346\234\237:", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("ArBillWin", "\345\244\207    \346\263\250:", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("ArBillWin", "\346\224\266\344\273\230\347\261\273\345\236\213:", 0, QApplication::UnicodeUTF8));
        depLabel->setText(QApplication::translate("ArBillWin", "\344\270\232\345\212\241\351\203\250\351\227\250:", 0, QApplication::UnicodeUTF8));
        personLabel->setText(QApplication::translate("ArBillWin", "\344\270\232 \345\212\241 \345\221\230:", 0, QApplication::UnicodeUTF8));
        settleLabel->setText(QApplication::translate("ArBillWin", "\347\273\223\347\256\227\346\226\271\345\274\217:", 0, QApplication::UnicodeUTF8));
        bankNameLabel->setText(QApplication::translate("ArBillWin", "\351\223\266\350\241\214\345\220\215\347\247\260:", 0, QApplication::UnicodeUTF8));
        arLabel->setText(QApplication::translate("ArBillWin", "\345\272\224\346\224\266\344\275\231\351\242\235:", 0, QApplication::UnicodeUTF8));
        preLabel->setText(QApplication::translate("ArBillWin", "\351\242\204\346\224\266\344\275\231\351\242\235:", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("ArBillWin", "\345\256\241 \346\240\270 \344\272\272:", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("ArBillWin", "\345\210\266 \345\215\225 \344\272\272:", 0, QApplication::UnicodeUTF8));
        bankLabel->setText(QApplication::translate("ArBillWin", "\351\223\266\350\241\214\345\270\220\345\217\267:", 0, QApplication::UnicodeUTF8));
        toolBar->setWindowTitle(QApplication::translate("ArBillWin", "toolBar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class ArBillWin: public Ui_ArBillWin {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ARBILLWIN_H
