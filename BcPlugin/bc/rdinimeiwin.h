#ifndef RDINIMEIWIN_H
#define RDINIMEIWIN_H
...
class RdInImeiWin : public QMainWindow
{
    Q_OBJECT
    LOG4QT_DECLARE_QCLASS_LOGGER
public:
    explicit RdInImeiWin(QWidget *parent = 0);
    RdInImeiWin(QString no,QWidget *parent = 0);
    RdInImeiWin(int rdf, QString vouchType, QWidget *parent = 0);
