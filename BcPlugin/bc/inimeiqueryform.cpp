#include "inimeiqueryform.h"
#include "bcplugin.h"
#include "haokeapp.h"
#include "rdinimeiwin.h"

InImeiQueryForm::InImeiQueryForm(QWidget *parent) :
    SingleQueryForm(parent)
{
    QString dSql1 = "SELECT a.*, c.emp_name, b.dep_name "
                ...
                " AND ( a.vouch_type='01' OR a.vouch_type='15' OR a.vouch_type='12' "
                " OR (a.vouch_type='05' AND a.bus_type<>'调拨入库') ) "
                " AND is_handle=true "
...
void InImeiQueryForm::sTableClicked(QString no){
    if(no.length()>1){
