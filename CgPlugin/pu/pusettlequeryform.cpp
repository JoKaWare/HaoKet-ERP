    ...
    QueryForm(parent)
{
    ...
    childItemProperties listItem[] = {
            ...
            { "rd_no","入库单号","入库单号", 3,100, true, false },
            { "supplier_id","编码","供应商", 4,80, true, false },
            { "supplie_name","名称","供应商", 5, 120,true, true },
    ...
    childItemProperties childItem[] = {
            ...
            { "rd_no","入库单号","入库单号", 5,100, true, true },
