    ...
    QueryForm(parent)
{
    ...
    childItemProperties listItem[] = {
            ...
            { "emp_name","采购员","采购员", 8,60, true, false },
    ...
    childItemProperties childItem[] = {
            ...
            { "unit","采购单位","采购单位", 10,60, true, false },
            { "quantity","数量","数量", 11, 60,true, true },
            { "price","采购单价","采购单价", 12,80, true, true },
