#ifndef PURETURNEDWIN_H
#define PURETURNEDWIN_H
...
class PuReturnedWin : public QMainWindow
{
    Q_OBJECT
    
public:
    explicit PuReturnedWin(QWidget *parent = 0);
    PuReturnedWin(QString no,QWidget *parent = 0);
    ~PuReturnedWin();
private slots:
    void sNew();
    void sEdit();
