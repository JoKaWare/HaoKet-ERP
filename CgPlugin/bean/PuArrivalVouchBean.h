#ifndef PUARRIVALVOUCHBEAN_H
#define PUARRIVALVOUCHBEAN_H
#include <QObject>
#include <QDateTime>
#include "lib_global.h"

class PuArrivalVouchBean : public QObject{
    Q_OBJECT
    ...
    Q_PROPERTY(QString puType READ puType WRITE setPuType)
...
public:
    ...
    QString puType() { return m_pu_type;}
    void setPuType(QString type){ m_pu_type = type;}
