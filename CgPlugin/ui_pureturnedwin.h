/********************************************************************************
** Form generated from reading UI file 'pureturnedwin.ui'
**
...
#ifndef UI_PURETURNEDWIN_H
#define UI_PURETURNEDWIN_H
...
public:
    ...
    void setupUi(QMainWindow *PuReturnedWin)
    {
        if (PuReturnedWin->objectName().isEmpty())
            PuReturnedWin->setObjectName(QString::fromUtf8("PuReturnedWin"));
        PuReturnedWin->resize(992, 600);
        centralwidget = new QWidget(PuReturnedWin);
        ...
        PuReturnedWin->setCentralWidget(centralwidget);
        toolBar = new QToolBar(PuReturnedWin);
        toolBar->setObjectName(QString::fromUtf8("toolBar"));
        PuReturnedWin->addToolBar(Qt::TopToolBarArea, toolBar);
        statusBar = new QStatusBar(PuReturnedWin);
        statusBar->setObjectName(QString::fromUtf8("statusBar"));
        PuReturnedWin->setStatusBar(statusBar);

        retranslateUi(PuReturnedWin);

        QMetaObject::connectSlotsByName(PuReturnedWin);
    } // setupUi

    void retranslateUi(QMainWindow *PuReturnedWin)
    {
        PuReturnedWin->setWindowTitle(QApplication::translate("PuReturnedWin", "MainWindow", 0, QApplication::UnicodeUTF8));
        label_16->setText(QApplication::translate("PuReturnedWin", "<html><head/><body><p><span style=\" color:#ff0000;\">\351\207\207\350\264\255\351\200\200\350\264\247\345\215\225</span></p></body></html>", 0, QApplication::UnicodeUTF8));
        idLabel->setText(QApplication::translate("PuReturnedWin", "\351\200\200\350\264\247\345\215\225\345\217\267:", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("PuReturnedWin", "\351\200\200\350\264\247\346\227\245\346\234\237:", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("PuReturnedWin", "\345\244\207    \346\263\250:", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("PuReturnedWin", "\351\207\207\350\264\255\351\203\250\351\227\250:", 0, QApplication::UnicodeUTF8));
        label_12->setText(QApplication::translate("PuReturnedWin", "\351\207\207 \350\264\255 \345\221\230:", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("PuReturnedWin", "\344\276\233 \345\272\224 \345\225\206:", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("PuReturnedWin", "\345\205\245\345\272\223\344\273\223\345\272\223:", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("PuReturnedWin", "\345\210\266 \345\215\225 \344\272\272:", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("PuReturnedWin", "\345\256\241 \346\240\270 \344\272\272:", 0, QApplication::UnicodeUTF8));
        toolBar->setWindowTitle(QApplication::translate("PuReturnedWin", "toolBar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class PuReturnedWin: public Ui_PuReturnedWin {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PURETURNEDWIN_H
