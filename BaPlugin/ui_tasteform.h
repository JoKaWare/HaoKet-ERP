/********************************************************************************
** Form generated from reading UI file 'tasteform.ui'
**
...
#ifndef UI_TASTEFORM_H
#define UI_TASTEFORM_H
...
public:
    ...
    void setupUi(QWidget *TasteForm)
    {
        if (TasteForm->objectName().isEmpty())
            TasteForm->setObjectName(QString::fromUtf8("TasteForm"));
        TasteForm->resize(898, 472);
        verticalLayout = new QVBoxLayout(TasteForm);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        splitter = new QSplitter(TasteForm);
        ...
        QWidget::setTabOrder(nameEdit, captionEdit);
        QWidget::setTabOrder(captionEdit, editButton);
        QWidget::setTabOrder(editButton, newButton);
        QWidget::setTabOrder(newButton, saveButton);
        QWidget::setTabOrder(saveButton, delButton);
        QWidget::setTabOrder(delButton, tableView);
        QWidget::setTabOrder(tableView, cancelButton);

        retranslateUi(TasteForm);

        QMetaObject::connectSlotsByName(TasteForm);
    } // setupUi

    void retranslateUi(QWidget *TasteForm)
    {
        TasteForm->setWindowTitle(QApplication::translate("TasteForm", "Taste Set", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        newButton->setToolTip(QApplication::translate("TasteForm", "New", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        newButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        delButton->setToolTip(QApplication::translate("TasteForm", "Del", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        delButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        cancelButton->setToolTip(QApplication::translate("TasteForm", "Exit", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        cancelButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        saveButton->setToolTip(QApplication::translate("TasteForm", "Save", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        saveButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        editButton->setToolTip(QApplication::translate("TasteForm", "Edit", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        editButton->setText(QString());
        groupBox->setTitle(QApplication::translate("TasteForm", "Taste Information", 0, QApplication::UnicodeUTF8));
        captionLabel->setText(QApplication::translate("TasteForm", "Taste Capion:", 0, QApplication::UnicodeUTF8));
        nameLabel->setText(QApplication::translate("TasteForm", "Taste Name:", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class TasteForm: public Ui_TasteForm {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TASTEFORM_H
