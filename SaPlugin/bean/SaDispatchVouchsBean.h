#ifndef SADISPATHCVOUCHSBEAN_H
#define SADISPATHCVOUCHSBEAN_H
#include <QObject>

class SaDispatchVouchsBean : public QObject{
    Q_OBJECT
    Q_PROPERTY(int id READ id WRITE setId)
    Q_PROPERTY(QString orderNo READ orderNo WRITE setOrderNo)
    Q_PROPERTY(QString dispatchNo READ dispatchNo WRITE setDispatchNo)
...
public:
    ...
    QString dispatchNo() { return m_dispatch_no;}
    void setDispatchNo(QString no) { m_dispatch_no = no;}
