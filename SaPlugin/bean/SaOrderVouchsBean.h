#ifndef SAORDERVOUCHSBEAN_H
#define SAORDERVOUCHSBEAN_H

#include <QObject>
#include "lib_global.h"
class SaOrderVouchsBean : public QObject{
    Q_OBJECT
    ...
    Q_PROPERTY(double puQuantity READ puQuantity WRITE setPuQuantity)
...
public:
    ...
    void setOutQuantity(double quantity) { m_out_quantity = quantity;}
    ...
    double puQuantity() { return m_pu_quantity;}
    void setPuQuantity(double quantity) { m_pu_quantity = quantity;}
