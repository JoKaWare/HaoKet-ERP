#ifndef SACONDELIVERWIN_H
#define SACONDELIVERWIN_H
...
namespace Ui {
class SaConDeliverWin;
}

class SaConDeliverWin : public QMainWindow
{
    Q_OBJECT
    
public:
    explicit SaConDeliverWin(QWidget *parent = 0);
    SaConDeliverWin(QString no,QWidget *parent = 0);
    ~SaConDeliverWin();
