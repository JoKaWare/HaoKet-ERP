#ifndef SACONSETTLEWIN_H
#define SACONSETTLEWIN_H
...
namespace Ui {
class SaConSettleWin;
}

class SaConSettleWin : public QMainWindow
{
    Q_OBJECT
    
public:
    explicit SaConSettleWin(QWidget *parent = 0);
    SaConSettleWin(QString no,QWidget *parent = 0);
    ~SaConSettleWin();
private slots:
    void sNew();
    void sEdit();
