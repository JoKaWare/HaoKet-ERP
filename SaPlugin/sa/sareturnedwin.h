#ifndef SARETURNEDWIN_H
#define SARETURNEDWIN_H
...
class SaReturnedWin : public QMainWindow
{
    Q_OBJECT
    
public:
    explicit SaReturnedWin(QWidget *parent = 0);
    SaReturnedWin(QString no,QWidget *parent = 0);
    ~SaReturnedWin();
private slots:
    void sNew();
    void sEdit();
