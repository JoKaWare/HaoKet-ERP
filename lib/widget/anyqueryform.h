#ifndef ANYQUERYFORM_H
#define ANYQUERYFORM_H
...
class LIBSHARED_EXPORT AnyQueryForm  : public QWidget
{
    Q_OBJECT
    LOG4QT_DECLARE_QCLASS_LOGGER
public:
    AnyQueryForm(QWidget *parent);
    AnyQueryForm(QList<childItemProperties> dItem, QString dSql, QString dSql1, QWidget *parent);
