#ifndef PRODUCTTYPEBEAN_H
#define PRODUCTTYPEBEAN_H

#include <QObject>
#include "lib_global.h"

class LIBSHARED_EXPORT ProductTypeBean :public QObject{
    Q_OBJECT
    ...
    Q_PROPERTY(bool isDishes READ isDishes WRITE setIsDishes)
public:

    virtual ~ProductTypeBean() {}
    ...
    bool isDishes() const { return m_is_dishes;}
    void setIsDishes(bool b) { m_is_dishes=b;}
private:
    QString m_type_id;
    QString m_type_name;
    bool m_type_end;
